...
function Footer() {
  return (
    <footer className="footer-wrapper">
		...
		<h3 className="all"><a href="https://www.linkedin.com/in/eliyas-daba-b5793b27a/">Built By Eliyas Daba</a></h3>
	</footer> 
  )
}
